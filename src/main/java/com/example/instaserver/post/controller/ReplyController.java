...
public class ReplyController {
    ...
    public ReplyResponse reply(@CurrentUser User user, @RequestBody @Valid ReplyCreateRequest replyCreateRequest) {
        return replyService.write(user, replyCreateRequest);
    }

    @PutMapping("reply")
    @ResponseStatus(HttpStatus.OK)
    public ReplyResponse updateReply(@CurrentUser User user, @RequestBody @Valid ReplyUpdateRequest replyUpdateRequest) {
        return replyService.update(user, replyUpdateRequest);
    }

    @DeleteMapping("reply")
    @ResponseStatus(HttpStatus.OK)
    public ReplyDeleteDto deleteReply(@CurrentUser User user, @RequestBody @Valid ReplyDeleteDto replyDeleteDto) {
